...
/**
 * Servlet Filter implementation class EncodeFiter
 */
//@WebFilter("/*")

//urlMapping하는 벙법2가지 (XML, 어노테이션) 여기서는 XML방식을 사용했음
//@WebFilter(urlPatterns = {"/*","/a","/bbb"}, initParams = { @WebInitParam(name="encoding",value="utf-8")})
